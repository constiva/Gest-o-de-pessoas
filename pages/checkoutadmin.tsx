...
import adminConfig from '../config/checkoutadmin.json';
      ...
      <section>
        ...
        >
          ...
          <input
            ...
            defaultValue={adminConfig.defaultPlan.interval}
          />
          <input
            name="repeats"
            ...
            type="number"
            className="border p-1 w-24"
            defaultValue={adminConfig.defaultPlan.repeats ?? ''}
          />
      ...
      <section>
        ...
        >
          ...
          <input
            ...
            defaultValue={adminConfig.defaultItem.name}
          />
          <input
            name="value"
            ...
            defaultValue={adminConfig.defaultItem.value}
          />
          <button className="bg-green-500 text-white px-2 py-1">Criar</button>
        </form>
      </section>
