...
function CenteredLabel({ x, y, width, height, payload }: any) {
  if (!payload) return null;
  // Recharts supplies x at the bar's right edge before our custom centering.
  // Subtract half the original width to realign the label to the visual center.
