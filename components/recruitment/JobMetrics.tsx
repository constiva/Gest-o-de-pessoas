  ...
  return (
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <div className="grid gap-4">
        <Card>
          <div className="p-4">
            <h2 className="font-semibold mb-2">Tempo médio para preencher vaga</h2>
        ...
        <Card>
          <div className="p-4">
            <h2 className="font-semibold mb-4">Tempo médio em cada etapa</h2>
            {radarData.length ? (
        ...
        <Card>
          <div className="p-4">
            <h2 className="font-semibold mb-4">SLA compliance</h2>
