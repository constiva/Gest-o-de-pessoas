...
- **job_metrics**: estatísticas agregadas por vaga (ex.: cliques no link e tempo de fechamento da vaga calculado do `jobs.created_at` até a primeira entrada na última etapa).
